...
#// Substitute the variables into the actual value.
...
#// Group the metadata accordingly
GROUP() {
  awk -F '!=!' '{
    category = $1
...
#// Display on the terminal if rofi is not found or have -j flag

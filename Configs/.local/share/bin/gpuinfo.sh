...
detect() {
    # Auto detect Gpu used by Hyprland(declared using env = WLR_DRM_DEVICES) Sophisticated?
...
intel_GPU() {
    #? Function to query basic intel GPU
    primary_gpu="Intel ${intel_gpu}"
    general_query
}

nvidia_GPU() {
    #? Function to query Nvidia GPU

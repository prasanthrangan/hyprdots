...
s)  grimblast  --freeze copysave area $temp_screenshot && swappy -f $temp_screenshot ;;
...
*)  echo "...valid options are..."
    ...
    echo "s : snip current screen or focused window to $save_dir"   
    echo "m : print current monitor to $save_dir"   
    exit 1 ;;
esac
rm "$temp_screenshot"

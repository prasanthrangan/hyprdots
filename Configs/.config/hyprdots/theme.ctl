1|Catppuccin-Mocha|Catppuccin.catppuccin-vsc~Catppuccin Mocha|~/.config/swww/Catppuccin-Mocha/rebellious_tower.png
...
0|Synth-Wave|robbowen.synthwave-vscode~SynthWave '84|~/.config/swww/Synth-Wave/glitch fox.png
0|Nordic-Blue|arcticicestudio.nord-visual-studio-code~Nord|~/.config/swww/Nordic-Blue/mountains.jpg
0|Rain-Dark||~/.config/swww/Rain-Dark/rain_wp.png

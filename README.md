...
<br>
-->
<div style="border: 2px solid #f39c12; padding: 20px; border-radius: 10px; background-color: #fdf2e9; color: #d35400; font-size: 32px; text-align: center; width: 100%; box-sizing: border-box; position: relative;">
  <strong>
      ⚠️ Deprecation Notice:</strong><br>
